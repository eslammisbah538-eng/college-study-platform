...
export const structureService = {
    ...
    deleteUniversity: (id) => api.delete(`/universities/${id}`).then((res) => res.data.data),
    ...
    deleteCollege: (id) => api.delete(`/colleges/${id}`).then((res) => res.data.data),
    ...
    deleteDepartment: (id) => api.delete(`/departments/${id}`).then((res) => res.data.data),
    ...
    deleteAcademicYear: (id) => api.delete(`/academic-years/${id}`).then((res) => res.data.data),
    ...
    deleteSemester: (id) => api.delete(`/semesters/${id}`).then((res) => res.data.data),
};
